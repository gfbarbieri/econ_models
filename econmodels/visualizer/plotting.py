def plot_utility():
    ...
    The relevant range is where quantity of the varaible good is greater
    than or equal to zero and the utility is greater than or equal to zero.
...
def plot_indifference():
    ...
    The relevant range is where the quantity of both goods is greater than or
    equal to zero.
...
def plot_demand():
    ...
    The relevant range of quantity and price is where price and quantity are
...
def plot_peqd():
    ...
    function to calculate prices and both are used to calculate elasticity.

    The relevant range of quantity is a minimum quantity of 0 and a maximum quantity
    where price is equal to zero, p(q) = 0.
