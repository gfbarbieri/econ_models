...
class Firm():
    ...
    Each firm takes as an argument the demand function they face and the parameters
    of their cost function. Firms use both of these inputs to construct a profit function
    and 
    
    If no demand function is explicitly passed, then a default demand function is created.
    For a competitive firm, the demand function the firm faces is constant. For
    a monopolist, the demand function the firm faces is downward sloping.

    The firm takes as arguments the *parameters* of a cost function, internal to the
    firm. The cost function is a combination  of the various inputs into production.
